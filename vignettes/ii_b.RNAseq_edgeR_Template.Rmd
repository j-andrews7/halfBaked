---
title: "halfBaked - RNA-seq - edgeR Differential Expression"
author: 
  - name: Jared Andrews
    affiliation:
...
vignette: >
  %\VignetteIndexEntry{halfBaked edgeR RNA-seq Template}
...
resource_files:
  ...
  - "images/GO_cluster_terms_example.png"
---
...
[edgeR](https://bioconductor.org/packages/release/bioc/html/edgeR.html) via [halfBaked](https://j-andrews7.github.io/halfBaked/).
It is meant to be a starting point for your own analysis and is not a comprehensive guide to all the options available in edgeR or halfBaked.
...
See `halfBaked::get_edgeR_res()` for more details on the parameters.
...
write.xlsx(res, file = "./de/All.Comparisons.DEGs.edgeR.xlsx", overwrite = TRUE)
```
...
# Delete me if using as a template
knitr::include_graphics("./images/GO_cluster_terms_example.png")
```
...
The edgeR authors recommend using the p-value for ranking.
