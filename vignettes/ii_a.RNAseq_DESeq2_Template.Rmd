...
This function largely uses the [clusterProfiler](https://yulab-smu.top/biomedical-knowledge-mining-book/enrichment-overview.html) package and spits out a boatload of figures and tables in the output directory.
...
kegg_res <- run_enrichment2(res, OrgDb = orgdb, method = "KEGG", species = params$species)
rct_res <- run_enrichment2(res, OrgDb = orgdb, method = "Reactome", species = params$species)
go_res <- run_enrichment2(res, OrgDb = orgdb, method = "GO", species = params$species)
```
