...
if (params$ercc) {
    ...
    # Save fractions
    write.table(spikeFraction, "spike_fraction.txt", sep = "\t", 
...
if (params$ercc) {
    ...
    res.spike <- get_DESEQ2_res(dds.spike,
        ...
        norm.ercc = TRUE, add.rowData = c("ENSEMBL", "SYMBOL")
    )
    ...
    write.xlsx(res.spike, 
               file = "./de/ERCC_spike/All.Comparisons.DEGs.ERCC_spikein.xlsx",
               overwrite = TRUE)
